...
@section('content')
	...
	<div class="col-lg-12">
		...
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" enctype='multipart/form-data' method="POST" action="{{route('post.update',['id' => $post->id])}}">
				{{ csrf_field() }}
				<div class="m-portlet__body">	
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							<label>Title:</label>
							<input name="title" type="text" class="form-control m-input" value="{{$post->title}}">
						...
						<div class="col-lg-6">
							...
							<textarea name="keyword"  class="form-control m-input" id="exampleTextarea" rows="3">{{$post->keyword}}</textarea>
						</div>

						<div class="col-lg-6">
							<label for="exampleTextarea">Enter Short Description</label>
							<textarea name="short_desc"  class="form-control m-input" id="exampleTextarea" rows="3">{{$post->short_desc}}</textarea>
						</div>
