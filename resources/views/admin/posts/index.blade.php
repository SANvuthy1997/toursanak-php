	...
	<div class="m-portlet__body">
		...
		<table class="m-datatable" id="html_table" width="100%">
			...
			<tbody>
				...
				<tr>
					<td>
						<img src="{{$post->featured}}" class="m--marginless m--img-centered" alt="#" width="50px;" height="60px;" style="border-radius: 5px;">
					</td>
					...
					<td data-field="Actions" class="m-datatable__cell">
						<span style="overflow: visible; width: 110px;">	
							<a href="{{route('post.edit',['id' => $post->id])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View ">       
