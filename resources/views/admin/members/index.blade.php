	...
	<div class="m-portlet__body">
		...
		<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
			<div class="row align-items-center">
				...
				<div class="col-xl-4 order-1 order-xl-2 m--align-right">
					<a href="{{route('member.create')}}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
		...
		<table class="m-datatable" id="html_table" width="100%">
			...
			<tbody>
				...
				<tr>
					<td>
						<img src="{{$member->photo}}" class="m--marginless m--img-centered" alt="#" width="50px;" height="50px;" style="border-radius: 5px;">
					</td>
					<td>{{$member->name}}</td>
					...
					<td data-field="Actions" class="m-datatable__cell">
						<span style="overflow: visible; width: 110px;">	
							<a href="{{route('member.edit',['id' => $member->id])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View ">       
						...
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<form action="{{route('member.delete',['id'=>$member->id])}}" method="get">
