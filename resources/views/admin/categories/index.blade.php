				...
				<tr>
					...
					<td data-field="Actions" class="m-datatable__cell">
						<span style="overflow: visible; width: 110px;">	
							<a href="{{route('category.edit',['id' => $category->id])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View ">       
					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<form action="{{route('category.delete',['id'=>$category->id])}}" method="get">
