...
<head>
    <meta charset="utf-8" />
    <title>Metronic | Form Wizard 1</title>
...
<div class="m-grid m-grid--hor m-grid--root m-page">
				...
				<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-3" id="m_login" style="background-image: url({{asset('admin/app/media/img/bg/bg-2.jpg')}})">
			...
			<div class="m-login__signin">
				...
				<form class="m-login__form m-form" action="{{ route('login') }}" method="POST">
					...
					<div class="form-group m-form__group{{ $errors->has('email') ? ' has-error' : '' }}">
						<input class="form-control m-input" type="email" placeholder="Email" name="email" value="{{ old('email') }}" required autofocus id="email">
					...
					<div class="">
						<button class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn" type="submit">Sign In</button>
					</div>
				</form>
			</div>
