						...
						<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
							...
							<ul class="m-menu__subnav">
								<li class="m-menu__item "  aria-haspopup="true">
									<a  href="index07a2.html?page=header/actions&amp;demo=default" class="m-menu__link ">
					...
					<ul class="m-topbar__nav m-nav m-nav--inline">
						...
						<li class="m-nav__item m-topbar__notifications m-topbar__notifications--img m-dropdown m-dropdown--large m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-center 	m-dropdown--mobile-full-width" data-dropdown-toggle="click" data-dropdown-persistent="true">
							...
							<div class="m-dropdown__wrapper">
								<span class="m-dropdown__arrow m-dropdown__arrow--center"></span>
								<div class="m-dropdown__inner">
									<div class="m-dropdown__header m--align-center" style="background: url({{asset('admin/app/media/img/misc/notification_bg.jpg')}}); background-size: cover;">
						...
						<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
							<a href="#" class="m-nav__link m-dropdown__toggle">
								<span class="m-topbar__userpic">
									<img src="{{asset('admin/app/media/img/users/user4.jpg')}}" class="m--img-rounded m--marginless m--img-centered" alt=""/>
								</span>
			...
			<div 
				...
				<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
					...
					<li class="m-menu__section">
			            <h4 class="m-menu__section-text">View your awesome website</h4>
			            <i class="m-menu__section-icon flaticon-more-v3"></i>
		            </li>
		            <li class="m-menu__item " aria-haspopup="true" >
		            	<a  href="/" class="m-menu__link " target="_blank">
		            		<i class="m-menu__link-icon flaticon-imac"></i>
		            		<span class="m-menu__link-text">Frontend</span>
		            	</a>
		            </li>

		            <li class="m-menu__section">
			            <h4 class="m-menu__section-text">Frontend hosting</h4>
			            <i class="m-menu__section-icon flaticon-more-v3"></i>
		            </li>
		            <li class="m-menu__item  m-menu__item--submenu {{ Request::is('admin/post/*') ? 'm-menu__item--open' : '' }}" aria-haspopup="true"  data-menu-submenu-toggle="hover">
		            	<a  href="#" class="m-menu__link m-menu__toggle">
		            	...
		            	<div class="m-menu__submenu">
		            		...
		            		<ul class="m-menu__subnav">
		            			<li class="m-menu__item {{ Request::is('admin/post/index') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            			...
		            			<li class="m-menu__item {{ Request::is('admin/post/create') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            				<a  href="{{route('post.create')}}" class="m-menu__link ">
		            					<i class="m-menu__link-bullet m-menu__link-bullet--dot">
		            						<span></span>
		            					</i>
		            					<span class="m-menu__link-text">New Post</span>
		            				</a>
		            			</li>
		            		</ul>
		            	</div>
		            ...
		            <li class="m-menu__item  m-menu__item--submenu {{ Request::is('admin/page/*') ? 'm-menu__item--open' : '' }}" aria-haspopup="true"  data-menu-submenu-toggle="hover">
		            	<a  href="#" class="m-menu__link m-menu__toggle">
		            	...
		            	<div class="m-menu__submenu ">
		            		<span class="m-menu__arrow"></span>
		            		<ul class="m-menu__subnav">
		            			<li class="m-menu__item {{ Request::is('admin/page/index') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            			...
		            			<li class="m-menu__item {{ Request::is('admin/page/create') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            				<a  href="{{route('page.create')}}" class="m-menu__link ">
		            					<i class="m-menu__link-bullet m-menu__link-bullet--dot">
		            						<span></span>
		            					</i>
		            					<span class="m-menu__link-text">New Page</span>
		            				</a>
		            			</li>
		            		</ul>
		            	</div>
		            ...
		            <li class="m-menu__item  m-menu__item--submenu {{ Request::is('admin/tag/*') ? 'm-menu__item--open' : '' }}" aria-haspopup="true"  data-menu-submenu-toggle="hover">
		            	<a  href="#" class="m-menu__link m-menu__toggle">
		            	...
		            	<div class="m-menu__submenu ">
		            		<span class="m-menu__arrow"></span>
		            		<ul class="m-menu__subnav">
		            			<li class="m-menu__item {{ Request::is('admin/tag/index') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            				<a  href="{{route('tag.index')}}" class="m-menu__link ">
		            					<i class="m-menu__link-bullet m-menu__link-bullet--dot">
		            						<span></span>
		            					</i>
		            					<span class="m-menu__link-text">All Tags</span>
		            				</a>
		            			</li>
		            			<li class="m-menu__item {{ Request::is('admin/tag/create') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            				<a  href="{{route('tag.create')}}" class="m-menu__link ">
		            					<i class="m-menu__link-bullet m-menu__link-bullet--dot">
		            						<span></span>
		            					</i>
		            					<span class="m-menu__link-text">New Tag</span>
		            				</a>
		            			</li>
		            		</ul>
		            	</div>
		            ...
		            <li class="m-menu__item  m-menu__item--submenu {{ Request::is('admin/category/*') ? 'm-menu__item--open' : '' }}" aria-haspopup="true"  data-menu-submenu-toggle="hover">
		            	<a  href="#" class="m-menu__link m-menu__toggle">
		            	...
		            	<div class="m-menu__submenu ">
		            		<span class="m-menu__arrow"></span>
		            		<ul class="m-menu__subnav">
		            			<li class="m-menu__item {{ Request::is('admin/category/index') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            			...
		            			<li class="m-menu__item {{ Request::is('admin/category/create') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            				<a  href="{{route('category.create')}}" class="m-menu__link ">
		            					<i class="m-menu__link-bullet m-menu__link-bullet--dot">
		            						<span></span>
		            					</i>
		            					<span class="m-menu__link-text">New Category</span>
		            				</a>
		            			</li>
		            		</ul>
		            	</div>
		            ...
		            <li class="m-menu__item  m-menu__item--submenu {{ Request::is('admin/member/*') ? 'm-menu__item--open' : '' }}" aria-haspopup="true"  data-menu-submenu-toggle="hover">
		            	<a  href="#" class="m-menu__link m-menu__toggle">
		            	...
		            	<div class="m-menu__submenu ">
		            		<span class="m-menu__arrow"></span>
		            		<ul class="m-menu__subnav">
		            			<li class="m-menu__item {{ Request::is('admin/member/index') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            			...
		            			<li class="m-menu__item {{ Request::is('admin/member/create') ? 'm-menu__item--active' : '' }}" aria-haspopup="true" >
		            				<a  href="{{route('member.create')}}" class="m-menu__link ">
		            					<i class="m-menu__link-bullet m-menu__link-bullet--dot">
		            						<span></span>
		            					</i>
		            					<span class="m-menu__link-text">New Member</span>
		            				</a>
		            			</li>
		            		</ul>
		            	</div>
		            ...
		            <li class="m-menu__item  m-menu__item--submenu {{ Request::is('admin/user/*') ? 'm-menu__item--open' : '' }}" aria-haspopup="true"  data-menu-submenu-toggle="hover">
		            ...
		            <li class="m-menu__item " aria-haspopup="true" >
		            	<a  href="index2b54.html?page=&amp;demo=default" class="m-menu__link ">
		...
		<div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
			<div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
				<span class="m-footer__copyright">
					2017 © Metronic theme by <a href="#" class="m-link">Keenthemes</a>
				</span>
			</div>
						...
						<div class="m-messenger__wrapper">
							<div class="m-messenger__message m-messenger__message--in">
								<div class="m-messenger__message-pic">
									<img src="{{asset('admin/app/media/img/users/user3.jpg')}}" alt=""/>
								</div>
...
<ul class="m-nav-sticky" style="margin-top: 30px;">
		<li class="m-nav-sticky__item" data-toggle="m-tooltip" title="Layout " data-placement="left">
		<a href="index2b54.html?page=&amp;demo=default"><i class="la la-cog"></i></a>
	</li>
		<!--
...
<!--begin::Page Resources --> 
	<script src="{{asset('admin/demo/default/custom/components/forms/wizard/wizard.js')}}" type="text/javascript"></script>
<!--end::Page Resources -->   
...
<!--begin::Page Resources --> 
	<script src="{{asset('admin/demo/default/custom/components/forms/widgets/summernote.js')}}" type="text/javascript"></script>
<!--end::Page Resources -->   
